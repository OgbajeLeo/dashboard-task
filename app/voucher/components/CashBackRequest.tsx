  ...
  return (
    <div className="w-full mt-[18px] p-5 bg-[#181818] rounded-xl slide-up">
      <div className="w-full h-[29px] mb-5 justify-between items-start flex">
        <div className="text-white text-2xl font-[400] ">Cashback requests</div>
          ...
          >
            <div className="self-stretch justify-start items-center gap-3 inline-flex">
              ...
              <div className="grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
                <div className="self-stretch text-white text-base font-[400]  leading-normal">
                  {request.value}
                </div>
                <div className="self-stretch justify-between items-start inline-flex">
                  <div className="px-3 py-1 bg-[#ba2543]/10 rounded-[100px] border border-[#ba2543]/30 justify-center items-center gap-2 flex">
                    <div className="text-[#ba2543] text-sm font-[300]  leading-normal">
                      {request.status}
                    </div>
                  </div>
                  <div className="self-stretch px-2 py-px bg-[#1d1d1d] rounded justify-start items-center gap-1 flex">
                    <div
                      className={`text-[#cdcdcc] text-xs font-[400] font-['Lato'] leading-tight ${lato.className}`}
                    >
                      {request.id}
                    </div>
                  </div>
            ...
            <div className="self-stretch justify-between items-start inline-flex">
              <div className="text-white text-[15px] font-[300]  leading-snug">
                Voucher price:
              </div>
              <div className="text-white text-[15px] font-[300]  leading-normal">
                {request.price}
              </div>
            </div>
