    ...
    <div className="w-[354px] p-[18px] bg-[#141414] rounded-xl flex-col justify-center items-start gap-3 inline-flex grow shrink basis-0">
      <div className="self-stretch justify-start items-center gap-3 inline-flex">
        ...
        <div className="grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
          <div className="self-stretch text-white text-base font-[400] font-['Figtree']">
            {voucher.title}
          </div>
      ...
      <div className="self-stretch justify-between items-start inline-flex">
        <div className="text-white text-[15px] font-[300]">Voucher price:</div>
        <div className="text-white text-[15px] font-[300]">
          ${voucher.price} / Unit
        </div>
      </div>

      <div className="self-stretch justify-between items-end inline-flex">
        <div className="text-white text-[15px] font-[300]">Niche:</div>
        <div className="text-white text-[15px] font-[300]">{voucher.niche}</div>
      </div>

      <div className="self-stretch justify-between items-start inline-flex">
        <div className="text-white text-[15px] font-[300]">Listed units:</div>
        <div className="text-white text-[15px] font-[300]">
          {voucher.listedUnits}
        </div>
      </div>
      ...
      <div className="self-stretch justify-between items-start inline-flex">
        ...
        <div className="w-8 h-8 justify-center items-center flex">
          ...
          >
            <path
              d="M12 29.3333H20C26.6667 29.3333 29.3333 26.6666 29.3333 20V12C29.3333 5.33329 26.6667 2.66663 20 2.66663H12C5.33334 2.66663 2.66667 5.33329 2.66667 12V20C2.66667 26.6666 5.33334 29.3333 12 29.3333Z"
              stroke="#A7FC00"
              strokeWidth="2"
              strokeLinecap="round"
  ...
  return (
    <div className="w-full p-5 bg-[#181818] rounded-xl mt-[18px] slide-up">
      <div className="flex justify-between items-center mb-5">
        <div className="text-white text-2xl font-[400]">Published vouchers</div>
        <button className="text-[#a7fc00] text-sm cursor-pointer hover:underline">
          See all
        </button>
      </div>
